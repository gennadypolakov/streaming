$(function () {
    ...
    $(document).on('click', '.submit-reset', function () {
        ...
        $form.find('input,textarea')
            .not(':button,:submit,:reset,:hidden,[type="checkbox"],[type="radio"]').val('');
 ...
 * @param params
 */
let btnSubmit = function (btn, params) {
    var def = {
        beforeSend: function () {
        },
        complete: function () {
 ...
 * @param params
 */
let btnTargetSubmit = function (btn, params) {
    var def = {
        beforeSend: function () {
        },
        complete: function () {
